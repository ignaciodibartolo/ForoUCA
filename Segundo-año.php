...
<body>
    <img src="https://i.ibb.co/rbtg8zz/ucalogo.png" alt="ucalogo" style="display: block; margin-left: auto; margin-right: auto; width: 50%; height:20%; width: 20%;">
    ...
    <?php
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                if(in_array($row['subj_id'], $array)) {                      
                        ...
                        <input type="submit" class="barra2"  value="Desuscribirse"> </form> <br>'. $row['subj_name'] .'</td>
